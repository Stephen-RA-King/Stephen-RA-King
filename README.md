...
[![OpenTofu](https://img.shields.io/badge/OpenTofu%20CI-3EAAAF?logo=opentofu&logoColor=fff)](#)
...
[![RaspberryPi](https://img.shields.io/badge/RaspberryPi-FF1B2D?logo=raspberrypi&logoColor=white)](#)
...
![](https://img.shields.io/badge/IaC-Pulumi-informational?style=flat&logo=pulumi&logoColor=white&color=ffae00)
...
[![Cisco](https://img.shields.io/badge/Cisco-4000BF?logo=cisco&logoColor=white)](#)
[![Pulumi](https://img.shields.io/badge/Pulumi-673DE6?logo=pulumi&logoColor=fff)](#)
...
[![Ansible](https://img.shields.io/badge/Ansible-C93CD7?logo=ansible&logoColor=white)](#)
...
- As a keen member of the maker community I utilise many flavours of [SBC's][sbc_tt] and microcontrollers in my [IoT][iot_tt] projects including Arduino, PyBoard, ESP8266, ESP32 etc.
...
- Sadly, life is short. So automation is the key. I try to automate as much as possible (at work and home). When 
securing tickets to a sold-out show felt like an Olympic sport, I put my Python powers to work — combining web scraping
(utilising [Selenium][selenium_url], [OpenCV][opencv_url], [Beautiful Soup][beautiful_soup_url] and 
[Scrapy][scrapy_url]) to monitor drops and beat the bots at their own game. Ethically questionable? Perhaps. Effective?
Absolutely. This one lives quietly in a private repository.
- When I'm not coding, inventing, soldering and welding I can usually be found golfing. It's surprising how cathartic 
whacking a little ball with a stick can be.
...
<a href="https://github.com/Stephen-RA-King/pydough">
  <img align="center" src="https://github-readme-stats-stephen-ra-king.vercel.app/api/pin/?username=Stephen-RA-King&repo=pydough&title_color=ffffff&text_color=c9cacc&icon_color=2bbc8a&bg_color=1d1f21" alt="readme stats" />
</a>
